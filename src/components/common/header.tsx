              ...
              <div className="flex items-center justify-between">
                  <div className="menu-left">
                      <ul>
                          <li>
                              ...
                              <Link onClick={ToggleMegaMenu} href="/over-ons" className="block ft-48 white-text carla">
                                  Over ons
                              </Link>
                          </li>
                          <li>
                              <span>Ons aanbod</span><br />
                              <Link onClick={ToggleMegaMenu}  href="/aanbod" className="block ft-48 white-text carla">
                                  Collectie
                              </Link>
                          </li>
                          <li>
                              <span>Hoe we het doen</span><br />
                              <Link onClick={ToggleMegaMenu}  href="/werkwijze" className="block ft-48 white-text carla">
                                  Werkwijze
                              </Link>
                          </li>
                          <li>
                              <span>Bereik ons</span><br />
                              <Link onClick={ToggleMegaMenu}  href="/contact" className="block ft-48 white-text carla">
                                  Contact
                              </Link>
                          </li>
                      </ul>
                  ...
                  <div className="menu-right">
                      <div className="menu-right-top flex items-end">
                          ...
                          <Link onClick={ToggleMegaMenu} href="/aanbod" className="primary-btn orange-bg arrow-btn">bekijk al het aanbod</Link>
                      </div>
